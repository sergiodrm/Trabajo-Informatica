...
bool Nave::atacar(Nave *nave_enemiga)
{
    ...
    {
        nave_enemiga->vida = nave_enemiga->vida - this->ataque*(1 - nave_enemiga->escudo/100);
        this->puntos_accion--;
        return true;
...
bool Nave::atacarEsp(Nave *nave_enemiga)
{
    if ( abs(this->pos.first - nave_enemiga->pos.first) + abs(this->pos.second - nave_enemiga->pos.second) <= this->rango_ataque && this->puntos_accion == PA_MAX)
    {
        nave_enemiga->vida = nave_enemiga->vida - this->ataque_especial*(1 - nave_enemiga->escudo/300);
